    ...
    <div className="trip-section">
      <div className="trip-header">
        <b className="header-text">
          <p>Discovering India&apos;s diverse landscapes,</p>
          <p>one scenic road trip at a time</p>
        </b>
      </div>
      ...
      <div className="trip-content">
        <div className="content-wrapper">
          <ul>
            ...
            <li>
              We cherish the freedom to stop, breathe in the fresh air, immerse
              in local cultures, and Savor regional cuisines along the way.
              These moments of discovery enrich your travels and create lasting
              memories through our rent a car service.
            </li>

            <li>
              No destination is too far or too close; we encourage you to
              explore the beauty around you with our car hire options. Pack your
              bags, set out on weekend adventures, and uncover the gems in your
              vicinity with our taxi service.
            </li>

            <li>
              Planning your trip is a breeze with our user-friendly website, or
              you can chat with our travel experts at <b>7860663399</b> for
              personalized guidance on car rental. Our cab booking app
              simplifies the process, ensuring a hassle-free experience when you
              rent a car.
            </li>

            <li>
              Our experienced drivers are your companions on the road, guiding
              you through India&apos;s best experiences with our car rental and taxi
